...
let appName = packageJson.name || "New React App";
let appSuffix = packageJson.suffix || "edit in package.json";
let appVer = packageJson.version || "ver 0.0.1 (Test)";
let appInfo = packageJson.info || "edit in package.json";
